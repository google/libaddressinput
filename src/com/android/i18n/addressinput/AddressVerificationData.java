...
/**
 * Wraps a Map of address property data to provide the AddressVerificationData
 * API.
 *
 */
public class AddressVerificationData {
  ...
  /**
   * Constructs from a map of address property data.  This keeps a reference
   * to the map.  This does not mutate the map. The map should not be mutated
  ...
  /**
   * Returns a set of the keys for which verification data is
   * provided.  The returned set is immutable.
   */
