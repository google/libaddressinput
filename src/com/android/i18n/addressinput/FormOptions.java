...
/**
 * Configuration Options that can be used by Address Display components for
 * things like show/hide fields or make them readonly. By default, all the
 * fields are visible and editable.
 *
 * <p>Also, provides the ability to add additional required fields, for e.g.
 * {@link AddressField#RECIPIENT}.
 */
public class FormOptions {
  ...
  /**
   * Gets the overridden field orders with their corresponding region code.
   * Returns null if field orders for {@code regionCode} is not specified.
   */
  ...
  public static class Builder {
    ...
    /**
     * Sets the field order for a region code. The order you set here will
     * override the predefined one. For example, you can set field order for US
     * to be first {@code AddressField#ORGANIZATION} then
     * {@code AddressField#RECIPIENT}. Repeated address fields in {@code fields}
     * are not allowed. Size of {@code fields} has to be larger than one. Input
     * {@code fields} can be partial or even contain field not needed in the
     * specified {@code regionCode}. For example, German addresses contain
     * the following fields (in order):<br/>
     * {@link AddressField#RECIPIENT}, {@link AddressField#ORGANIZATION},
     * {@link AddressField#STREET_ADDRESS}, {@link AddressField#POSTAL_CODE},
     * {@link AddressField#LOCALITY}. <br/>
     *
     * <p>With the following call: <br/>
     *
     * customizeFieldOrder("DE", AddressField.ORGANIZATION,
     *      AddressField.RECIPIENT, AddressField.ADMIN_AREA);
     *
     * <p>Field order for Germany will become: <br/>
     * {@link AddressField#ORGANIZATION}, {@link AddressField#RECIPIENT},
     * {@link AddressField#STREET_ADDRESS}, {@link AddressField#POSTAL_CODE},
     * {@link AddressField#LOCALITY}. </p>
     *
     * <p>Notice that:<br/>
     * <ol>
     * <li>{@link AddressField#ORGANIZATION} comes before
     *     {@link AddressField#RECIPIENT} after reordering.</li>
     * <li>Fields not specified stays the same.</li>
     * <li>{@link AddressField#ADMIN_AREA} is specified but since it is not
     *     in German address format, it is simpled neglected.</li>
     * </ol>
     *
    ...
    /**
     * Sets the URL of address data server. {@code url} cannot be null. This
     * url will override the default address server url.
     */
